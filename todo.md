Most van az első alkalom, hogy (nem senior) szoftverfejlesztőt felvételiztetek, azóta, hogy létezik AI. 

Ez a 2. kör, az otthon elkészítendő próbafeladat, kíváncsi vagyok, hogy az eredményből lehetséges lesz-e majd bármilyen értelmes következtetéseket levonni:
...
Időkeret: Tetszőleges (a feladat szerintünk nagyságrendileg 30-60 perc alatt megoldható). 

A feladat: Készíts egy egyszerű, publikusan is elérhető webalkalmazást az alábbi stack használatával:
...
Szeretnénk, ha a feladat megoldásához AI-t használnál. Nyugodtan támaszkodj rá a projekt inicializálásánál, az adatbázis-séma kitalálásánál, a kód megírásánál és a deployment hibák elhárításánál is.
